...
class CompoundsParser extends FileParser
{
	...
	protected void init() throws IOException, ParseException
	{
		...
		final int STAR = 9;
		final int STAR_SECONDARY = 8; // Temporary "hack" while compounds.tsv flatfile is fixed.
	...
	/**
	 * 
	 * @return array of allIds, of all primary and secondary ids belonging to one set, indexed by ChEBI id
	 * @throws IOException
	 * @throws ParseException 
	 */
